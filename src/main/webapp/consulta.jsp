...
<head>
    ...
    <title>Horóscopo Chino - Consulta</title>
</head>
...
<div class="container mt-5 ">
    <h1 class="text-center">Conoce a tu animal del horóscopo chino</h1>
    <div class="container my-5">
        <h2 class="text-center">Tu animal es <b><%= u.getAnimal() %></b></h2>
    </div>
</div>
